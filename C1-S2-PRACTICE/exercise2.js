...
const STUDENTS_DATA = [
    { firstName: "An", lastName: "Le", batch: "A1", age: 20 },
    { firstName: "Bình", lastName: "Trần", batch: "C1", age: 22 },
    { firstName: "Cẩm", lastName: "Quốc", batch: "A2", age: 21 },
    { firstName: "An", lastName: "Phạm", batch: "A3", age: 19 }, // Duplicate first name !
];
...
updateStudentAge("An", "Phạm", "A3", 30);
